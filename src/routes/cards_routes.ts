...
cardsRouter.patch("/card/:idCard/block", cardValidation, cardExpirationValidate, cardPasswordValidation, blockCard);
cardsRouter.patch("/card/:idCard/unblock", cardValidation, cardExpirationValidate, cardPasswordValidation, unblockCard);
